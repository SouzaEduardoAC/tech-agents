# Custom Productivity Audit Report
...
## 1. Executive Summary
`[A high-level summary of process health, highlighting board-to-git alignment, overall velocity, and the most critical bottlenecks.]`

---

## 2. Developer Activity & Traceability Telemetry

| Developer / Handle | Board Cards Completed | PRs Merged | Traceability (%) | PR Comment Density | Avg Cycle Time | Rework & Churn Index |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| `[Developer 1]` | `[Count]` | `[Count]` | `[XX%]` | `[Low/Med/High]` | `[X.X days]` | `[Low/Med/High]` |
| `[Developer 2]` | `[Count]` | `[Count]` | `[XX%]` | `[Low/Med/High]` | `[X.X days]` | `[Low/Med/High]` |

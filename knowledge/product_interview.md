# Standard: Product Elicitation & Interview Protocol (v2026)

This protocol governs the **interactive product elicitation and requirement grilling process** executed by the Product Owner to extract highly precise requirements from stakeholders before formulating the PRD.

---

## 1. The 5-Phase Elicitation Loop

The interview must proceed through five distinct, chronological phases. Do not advance to a new phase until all critical variables of the current phase are documented and confirmed.
...
When conducting the elicitation drill, adhere strictly to these communication rules:

...
> **Notice:** This document is the root-level reference for the v3 architecture. The canonical Logseq graph page is located at [`docs/pages/v3-architecture-spec.md`](docs/pages/v3-architecture-spec.md).
...
└── docs/pages/                  # Logseq Documentation Graph
    ├── v3-architecture-spec.md  # Canonical Logseq specification node
